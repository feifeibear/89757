...
import data_lstm as data
import models.model_lstm as model
        ...
        if batch % args.log_interval == 0 and batch > 0:
            ...
            if hvd.local_rank() == 0:
                print('| epoch {:3d} | {:5d}/{:5d} batches | lr {:02.2f} | ms/batch {:5.2f} | '
                    ...
                    elapsed * 1000 / args.log_interval, cur_loss, math.sqrt(cur_loss)))
            total_loss = 0
            start_time = time.time()
        # lr decay
        # if batch != 0 and batch % lr_decay_interval == 0:
        #     for param_group in optimizer.param_groups:
        #         lr = param_group['lr'] = param_group['lr'] / 4.0
    return optimizer
